  ...
  return (
    <form ref={formRef} className="w-full flex flex-col">
        <div className="w-full flex justify-between py-4 ">
            <Input required width={35} value={inputData.fName} placeholder="Employee's First Name" type="text" name="fName" onChange={(e:ChangeEvent)=>handleChange(e)}/>
            <Input required width={35} value={inputData.lName} placeholder="Employee's Last Name" type="text" name="lName" onChange={(e:ChangeEvent)=>handleChange(e)}/>
